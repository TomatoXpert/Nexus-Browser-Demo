...
This software and its source code are the intellectual property of **Nexus** Browser.

- Unauthorized copying, distribution, or commercial use is prohibited.
- **Nexus®** is a registered trademark and is legally protected.
- Any unauthorized use may result in legal action, including DMCA (Digital Millennium Copyright Act) takedowns.
